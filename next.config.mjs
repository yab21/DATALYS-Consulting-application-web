        ...
        headers: [
          ...
          },
          {
            ...
            value: process.env.NODE_ENV === 'production' 
              ...
              : "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https: blob: http:; connect-src 'self' http: https: ws: wss:; frame-src 'self'; worker-src 'self' blob:;",
          },
        ],
      },
