...
interface GererIncidentProps {
  id: string;
}

const GererIncident: React.FC<GererIncidentProps> = ({ id }) => {
  ...
  const handleReassign = async () => {
    ...
    try {
      ...
      if (result) {
        ...
        const successMessage = extractBackendMessage(result) || result?.message || "Incident réaffecté avec succès";
        showNotification(simpleNotificationHelpers.success(
          "Succès",
          successMessage
        ));
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        {/* En-tête de l'incident (identique à VoirIncident) */}
        <Card className="bg-white dark:bg-gray-800 shadow-2xl dark:shadow-gray-900/30 border-0 dark:border dark:border-gray-700 overflow-hidden">
          ...
          <CardHeader className="relative pb-8 pt-8 bg-gradient-to-r from-[#4ba9b7]/10 via-transparent to-red-500/10 dark:from-gray-800 dark:to-gray-700">
            <div className="flex flex-col gap-8 w-full">
              ...
              {/* Statistiques de l'incident (identique à VoirIncident) */}
        ...
        {/* Contenu principal avec onglets (identique à VoirIncident) */}
        <Card className="bg-white dark:bg-gray-800 shadow-2xl dark:shadow-gray-900/30 border-0 dark:border dark:border-gray-700 overflow-hidden">
              ...
              >
                <div className="p-8">
                  <div className="max-w-4xl mx-auto space-y-6">
                    <div className="text-center mb-8">
                      <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">
                        Réaffectation de l'incident
                      </h2>
                      <p className="text-gray-600 dark:text-gray-400">
                        Assignez cet incident à une autre ressource ou équipe
                      </p>
                    </div>
                      ...
                      <Card className="border border-gray-200 dark:border-gray-700">
                        ...
                        <CardBody className="space-y-4">
                          ...
                          <Button
                            ...
                            className="w-full"
                          >
                            {saving ? "Réaffectation..." : "Réaffecter l'incident"}
                          </Button>
                        </CardBody>
                      </Card>
                    </div>
