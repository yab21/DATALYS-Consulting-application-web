                ...
                <TableCell>
                  <div className="flex items-center gap-3">
                    {(() => {
                      ...
                      if (isValid && !hasError) {
                        return (
                          <div className="w-14 h-14 rounded-md border border-gray-200 dark:border-gray-700 overflow-hidden bg-white dark:bg-gray-800 flex items-center justify-center p-1.5 shadow-sm">
                            <img
                              src={fixedUrl!}
