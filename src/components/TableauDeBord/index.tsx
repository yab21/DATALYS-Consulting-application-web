...
interface Project {
  ...
  createdAt: Date;
  status: "en_cours" | "termine" | "en_attente" | "urgent";
  progress: number;
...
const TableauDeBord: React.FC = () => {
  ...
  const mockProjects: Project[] = [
    ...
    {
      id: "2",
      intitule: "Application Mobile Banking",
      societe: "FinanceX",
      domaine: ["Mobile", "FinTech"],
    ...
    {
      id: "3",
      intitule: "Dashboard Analytics BI",
      societe: "DataCorp Analytics",
      domaine: ["Analytics", "Business Intelligence"],
    ...
    {
      id: "4",
      intitule: "Site E-commerce",
      societe: "ShopFlow",
      domaine: ["Web", "E-commerce"],
      ...
      >
        <Card className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border border-blue-200 dark:border-blue-800 shadow-xl shadow-blue-500/10">
          <CardBody className="text-center p-6">
            ...
            <h3 className="text-3xl font-black text-gray-900 dark:text-white">{stats.totalProjects}</h3>
        ...
        <Card className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-800 shadow-xl shadow-green-500/10">
          <CardBody className="text-center p-6">
            ...
            <h3 className="text-3xl font-black text-gray-900 dark:text-white">{stats.activeProjects}</h3>
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20 border border-purple-200 dark:border-purple-800 shadow-xl shadow-purple-500/10">
          <CardBody className="text-center p-6">
            ...
            <h3 className="text-3xl font-black text-gray-900 dark:text-white">{stats.completedProjects}</h3>
        ...
        <Card className="bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 border border-orange-200 dark:border-orange-800 shadow-xl shadow-orange-500/10">
          <CardBody className="text-center p-6">
            ...
            <h3 className="text-3xl font-black text-gray-900 dark:text-white">{stats.totalFiles}</h3>
            <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Fichiers</p>
          </CardBody>
        </Card>

        <Card className="bg-gradient-to-br from-pink-50 to-rose-50 dark:from-pink-900/20 dark:to-rose-900/20 border border-pink-200 dark:border-pink-800 shadow-xl shadow-pink-500/10">
          <CardBody className="text-center p-6">
            <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-pink-500 to-rose-600 mx-auto shadow-lg">
              <svg className="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
              </svg>
            </div>
            <h3 className="text-3xl font-black text-gray-900 dark:text-white">{stats.teamMembers}</h3>
            <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Membres</p>
          </CardBody>
        </Card>

        <Card className="bg-gradient-to-br from-red-50 to-pink-50 dark:from-red-900/20 dark:to-pink-900/20 border border-red-200 dark:border-red-800 shadow-xl shadow-red-500/10">
          <CardBody className="text-center p-6">
            <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-red-500 to-pink-600 mx-auto shadow-lg">
              <svg className="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <h3 className="text-3xl font-black text-gray-900 dark:text-white">{stats.pendingTasks}</h3>
            <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Tâches En Cours</p>
          </CardBody>
        </Card>
      </motion.div>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-4 mb-3">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-medium text-gray-500">{project.teamSize} membres</span>
                          </div>
                          <Chip
                            size="sm"
                            ...
                            className="text-xs"
                          >
                            {project.priority === "high" ? "Haute" : project.priority === "medium" ? "Moyenne" : "Basse"} priorité
                          </Chip>
                        </div>
