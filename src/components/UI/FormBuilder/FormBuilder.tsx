...
const generateValidationSchema = (sections: FormSection[]): z.ZodObject<any> => {
...
export const FormBuilder: React.FC<FormBuilderProps> = ({
  ...
  // Rendu des champs
  const renderField = useCallback((field: FormField, sectionIndex: number, fieldIndex: number) => {
    ...
    return (
      <motion.div
        ...
        className={cn(
          "w-full",
          field.grid ? `col-span-${field.grid.sm || 1} md:col-span-${field.grid.md || field.grid.sm || 1}` : ""
        )}
          ...
          <Card>
            <CardBody className="p-4">
              <div className="flex items-center justify-between mb-2">
                <span className="text-small font-medium">Progression du formulaire</span>
              ...
              >
                <div className="flex items-center justify-between w-full">
                  <div>
                    ...
                    {section.description && (
                      <p className="text-small text-default-400 mt-1">{section.description}</p>
                    )}
                  </div>
                  {section.collapsible && (
                    <Button
